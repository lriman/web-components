...
import InputDateCalendarField from './_internal/InputDateCalendarField';
import InputCalendar from './_internal/InputCalendar';

export default class InputDateCalendar extends PureComponent {
  static REFS = REFS;

  static inputType = TYPES.DATE_CALENDAR;
    ...
    return (
      <Popup isOpened={!disabled && isOpened} onClose={this.onPopupClose}>
        <Opener display={Opener.REFS.DISPLAY.BLOCK} isNotAutoOpen>
          <InputDateCalendarField {...inputDateCalendarFieldProps} ref={this.inputNode} />
        </Opener>
        <Box>
          <InputCalendar {...inputCalendarProps} />
        </Box>
      </Popup>
    );
  }
