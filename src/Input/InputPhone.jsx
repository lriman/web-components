...
import { getChar, getCaretPosition, formatPhoneValue, deformatPhoneValue } from './_utils';
...
export default class InputPhone extends PureComponent {
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    if (
      ...
      const formattedValue = formatPhoneValue(props.value);
      const value = deformatPhoneValue(formattedValue);
      return {
        isInitialized: true,
        value,
        formattedValue,
  ...
  handleChange = e => {
    ...
    const deformattedValue = deformatPhoneValue(formattedValue);
